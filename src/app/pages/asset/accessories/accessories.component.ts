...
import { CreateMaintenanceComponent } from '../../maintenance/maintenance/create-maintenance.component';
import { DetailMaintenanceComponent } from '../../maintenance/maintenance/detail-maintenance.component';
import { CreateAccessoriesComponent } from './create-accessones.component';
import { DetailAccessoriesComponent } from './detail-accessrories.component';
...
export class AccessoriesComponent implements OnInit {
    ...
    handleCallbackSettingTable = (value) => {
        switch (value.type) {
            case 'create':
                return this.dialog.open(CreateAccessoriesComponent, {
                    width: '863px',
                    height: '563px',
                    data: value.item
            ...
            case 'delete':
                ...
                break;
            case 'edit':
                return this.dialog.open(DetailAccessoriesComponent, {
                    width: '863px',
                    height: '563px',
                    data: value.item
                }).afterClosed().subscribe(result => {
