...
export class DetailAccessoriesComponent implements OnInit {
    listCreate: any;
    conFig = new IoWarehouseModel;
    option = {
        title: 'Cập nhật hàng hóa nhập',
        type: 'create'
    };
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<DetailAccessoriesComponent>,
...
export class DetailAccessoriesModule { }